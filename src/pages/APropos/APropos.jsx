    ...
    <article className="section conteneur">
      ...
      <div className="lecture prose">
        ...
        <p>
          ...
          d’OpenClassrooms pour passer de la théorie à la pratique : douze
          projets livrés, du front statique à l’API sécurisée.
        </p>
        ...
        <p>
          ...
          que comme réponse. Dans les deux cas, ce qui compte est de comprendre
          pourquoi une solution marche, pas seulement qu’elle marche.
        </p>
        ...
        <p>
          ...
          expérimentées et prendre progressivement en charge des sujets
          complets. PHP est ma prochaine priorité d’apprentissage : il revient
          dans une grande partie des offres de la région grenobloise, et venant
          de Python et de JavaScript, c’est un terrain que je sais aborder.
        </p>
      </div>
    </article>
  )
